...
final class ModelSettingsStore: ObservableObject {
    ...
    @Published private(set) var runtimeConfigurationRevision = 0
    @Published var asrEnabled: Bool {
        didSet {
            save(asrEnabled, key: Keys.asrEnabled)
            runtimeConfigurationRevision &+= 1
        }
    }
    @Published var asrModel: String {
        didSet {
            save(asrModel, key: Keys.asrModel)
            runtimeConfigurationRevision &+= 1
        }
    }
    @Published var transcriptionLanguage: String {
        didSet {
            save(transcriptionLanguage, key: Keys.language)
            runtimeConfigurationRevision &+= 1
        }
    }
    @Published var maximumChunkDuration: Double {
        didSet {
            save(maximumChunkDuration, key: Keys.maximumChunkDuration)
            runtimeConfigurationRevision &+= 1
        }
    }
    ...
    @Published var automaticMeetingTitle: Bool { didSet { save(automaticMeetingTitle, key: Keys.automaticMeetingTitle) } }
    ...
    init(
        ...
        automaticMeetingTitle = defaults.object(forKey: Keys.automaticMeetingTitle) as? Bool ?? true
    ...
    private enum Keys {
        ...
        static let automaticMeetingTitle = "models.summary.automaticMeetingTitle"
